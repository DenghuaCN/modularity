...
! function (e, t) {
    ...
    function h(e) {
        return e.replace(Ie, "ms-").replace(Me, d)
    }
    ...
    function q(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Re.hasData(e) && (s = Re.access(e), u = we.extend({}, s), Re.set(t, u))
        }
    }
    ...
    function H(e, t, r, i) {
        ...
        if (p && (o = C(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
            for (u = (s = we.map(w(o, "script"), D)).length; f < p; f++) l = o, f !== d && (l = we.clone(l, !0, !0), u && we.merge(s, w(l, "script"))), r.call(e[f], l, f);
            if (u)
    ...
    function $(e) {
        var t = we.cssProps[e];
        return t || (t = we.cssProps[e] = M(e) || e), t
    }
    ...
    function _() {
        yt && (!1 === ae.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(_) : e.setTimeout(_, we.fx.interval), we.fx.tick())
    }
    ...
    function V(e, t, n) {
        ...
        for (r in t)
            if (i = t[r], xt.test(i)) {
                ...
                d[r] = m && m[r] || we.style(e, r)
            }
        if ((u = !we.isEmptyObject(t)) || !we.isEmptyObject(d)) {
            f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = m && m.display) && (l = We.get(e, "display")), "none" === (c = we.css(e, "display")) && (l ? c = l : (b([e], !0), l = e.style.display || l, c = we.css(e, "display"), b([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === we.css(e, "float") && (u || (p.done(function () {
                h.display = l
            }), null == l && (c = h.display, l = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function () {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            })), u = !1;
            for (r in d) u || (m ? "hidden" in m && (g = m.hidden) : m = We.access(e, "fxshow", {
                display: l
            }), o && (m.hidden = !g), g && b([e], !0), p.done(function () {
                g || b([e]), We.remove(e, "fxshow");
                for (r in d) we.style(e, r, d[r])
            })), u = U(g ? m[r] : 0, r, p), r in m || (m[r] = u.start, g && (u.end = u.start, u.start = 0))
        }
    }
    ...
    function Y(e, t, n) {
        ...
        for (G(c, l.opts.specialEasing); o < a; o++)
            if (r = Y.prefilters[o].call(l, e, c, l.opts)) return ye(r.stop) && (we._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
        return we.map(c, U, l), ye(l.opts.start) && l.opts.start.call(e, l), l.progress(l.opts.progress).done(l.opts.done, l.opts.complete).fail(l.opts.fail).always(l.opts.always), we.fx.timer(we.extend(u, {
            elem: e,
            anim: l,
            queue: l.opts.queue
        })), l
    ...
    var Ce = function (e) {
            ...
            if (!r && ((t ? t.ownerDocument || t : W) !== q && j(t), t = t || q, H)) {
                ...
                if (b.qsa && !z[e + " "] && (!O || !O.test(e))) {
                    if (1 !== h) d = t, p = e;
                        ...
                        for ((s = t.getAttribute("id")) ? s = s.replace(xe, be) : t.setAttribute("id", s = $), o = (c = k(e)).length; o--;) c[o] = "#" + s + " " + f(c[o]);
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || a)
                            if (f = t[$] || (t[$] = {}), c = f[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
                                ...
                                if ((l = c[o]) && l[0] === R && l[1] === s) return p[2] = l[2];
            ...
            var i = n.length > 0,
                ...
                a = function (r, a, s, u, l) {
                    var c, f, p, d = 0,
                        ...
                        T = x.length;
                    for (l && (A = a === q || a || l); h !== T && null != (c = x[h]); h++) {
                        if (o && c) {
        ...
        var x, b, w, T, C, k, E, S, A, N, D, j, q, L, H, O, P, I, M, $ = "sizzle" + 1 * new Date,
            W = e.document,
            R = 0,
            B = 0,
            F = n(),
        ...
        b = t.support = {}, C = t.isXML = function (e) {
            ...
            return r !== q && 9 === r.nodeType && r.documentElement ? (q = r, L = q.documentElement, H = !C(q), W !== q && (n = q.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), b.attributes = i(function (e) {
            ...
            })), (b.matchesSelector = he.test(I = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector)) && i(function (e) {
                b.disconnectedMatch = I.call(e, "*"), I.call(e, "[s!='']:x"), P.push("!=", re)
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === q || e.ownerDocument === W && M(W, e) ? -1 : t === q || t.ownerDocument === W && M(W, t) ? 1 : N ? K(N, e) - K(N, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return D = !0, 0;
                var n, r = 0,
                    i = e.parentNode,
            ...
            var t, n = [],
                r = 0,
                i = 0;
            if (D = !b.detectDuplicates, N = !b.sortStable && e.slice(0), e.sort(X), D) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                for (x = (d = (l = (c = (f = (p = m)[$] || (p[$] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === R && l[1]) && l[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();)
                                    if (1 === p.nodeType && ++x && p === t) {
                                        c[e] = [R, d, x];
                                        break
                                    }
                            } else if (y && (x = d = (l = (c = (f = (p = t)[$] || (p[$] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === R && l[1]), !1 === x)
                                for (;
                                    (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== v : 1 !== p.nodeType) || !++x || (y && ((c = (f = p[$] || (p[$] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [R, x]), p !== t)););
        ...
        return c.prototype = w.filters = w.pseudos, w.setFilters = new c, k = t.tokenize = function (e, n) {
            ...
            var n, r = [],
                ...
                o = z[e + " "];
            if (!o) {
                for (t || (t = k(e)), n = t.length; n--;)(o = v(t[n]))[$] ? r.push(o) : i.push(o);
        ...
        }, b.sortStable = $.split("").sort(X).join("") === $, b.detectDuplicates = !!D, j(), b.sortDetached = i(function (e) {
    ...
    (we.fn.init = function (e, t, n) {
        ...
        if (n = n || Ne, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof we ? t[0] : t, we.merge(this, we.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ae, !0)), Ae.test(r[1]) && we.isPlainObject(t))
    ...
    we.extend({
        hasData: function (e) {
            return Re.hasData(e) || We.hasData(e)
        },
        data: function (e, t, n) {
        ...
        data: function (e, t) {
            var n, r, i, o = this[0],
                a = o && o.attributes;
            if (void 0 === e) {
                if (this.length && (i = Re.get(o), 1 === o.nodeType && !We.get(o, "hasDataAttrs"))) {
    ...
    we.event = {
        ...
        add: function (e, t, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, g, m = We.get(e);
            if (m)
                for (n.handler && (n = (o = n).handler, i = o.selector), i && we.find.matchesSelector(et, i), n.guid || (n.guid = we.guid++), (u = m.events) || (u = m.events = {}), (a = m.handle) || (a = m.handle = function (t) {
        ...
        remove: function (e, t, n, r, i) {
            var o, a, s, u, l, c, f, p, d, h, g, m = We.hasData(e) && We.get(e);
            if (m && (u = m.events)) {
                for (l = (t = (t || "").match(Le) || [""]).length; l--;)
                    if (s = rt.exec(t[l]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
                        ...
                        a && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || we.removeEvent(e, d, m.handle), delete u[d])
                    } else
        ...
        e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? k : E, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && we.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[we.expando] = !0
    }, we.Event.prototype = {
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = h(t),
                    u = pt.test(t),
                    l = e.style;
                if (u || (t = $(s)), a = we.cssHooks[t] || we.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
                "string" == (o = typeof n) && (i = ze.exec(n)) && i[1] && (n = y(e, t, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (we.cssNumber[s] ? "" : "px")), ve.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
            }
        },
        css: function (e, t, n, r) {
            var i, o, a, s = h(t);
            return pt.test(t) || (t = $(s)), (a = we.cssHooks[t] || we.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = P(e, t, r)), "normal" === i && t in ht && (i = ht[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
        ...
        we.cssHooks[t] = {
            ...
            set: function (e, n, r) {
                var i, o = lt(e),
                    ...
                    s = r && R(e, t, r, a, o);
                return a && ve.scrollboxSize() === o.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - R(e, t, "border", !1, o) - .5)), s && (i = ze.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = we.css(e, t)), W(e, n, s)
            }
        }
    ...
    we.fn.extend({
        val: function (e) {
            ...
            })) : i ? (t = we.valHooks[i.type] || we.valHooks[i.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : "string" == typeof (n = i.value) ? n.replace(Et, "") : null == n ? "" : n : void 0
        }
    }), we.extend({
        valHooks: {
            option: {
    ...
    we.extend(we.event, {
        trigger: function (t, n, r, i) {
            ...
            if (a = p = s = r = r || ae, 3 !== r.nodeType && 8 !== r.nodeType && !St.test(h + we.event.triggered) && (h.indexOf(".") > -1 && (h = (g = h.split(".")).shift(), g.sort()), l = h.indexOf(":") < 0 && "on" + h, t = t[we.expando] ? t : new we.Event(h, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = g.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : we.makeArray(n, [t]), f = we.event.special[h] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                ...
                for (o = 0;
                    (a = d[o++]) && !t.isPropagationStopped();) p = a, t.type = o > 1 ? u : f.bindType || h, (c = (We.get(a, "events") || {})[t.type] && We.get(a, "handle")) && c.apply(a, n), (c = l && a[l]) && c.apply && $e(a) && (t.result = c.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = h, i || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(d.pop(), n) || !$e(r) || l && ye(r[h]) && !xe(r) && ((s = r[l]) && (r[l] = null), we.event.triggered = h, t.isPropagationStopped() && p.addEventListener(h, At), r[h](), t.isPropagationStopped() && p.removeEventListener(h, At), we.event.triggered = void 0, s && (r[l] = s)), t.result
            }
        },
    ...
    Xt.href = Nt.href, we.extend({
        ...
        ajax: function (t, n) {
            ...
            if (v.promise(C), h.url = ((t || h.url || Nt.href) + "").replace(Bt, Nt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Le) || [""], null == h.crossDomain) {
    ...
    ve.cors = !!Vt && "withCredentials" in Vt, ve.ajax = Vt = !!Vt, we.ajaxTransport(function (t) {
        var n, r;
    ...
    we.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = ye(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Yt, "$1" + i) : !1 !== t.jsonp && (t.url += (jt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
            return a || we.error(i + " was not called"), a[0]
        }, t.dataTypes[0] = "json", o = e[i], e[i] = function () {
            a = arguments
        }, r.always(function () {
            void 0 === o ? we(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Gt.push(i)), a && ye(o) && o(a[0]), a = o = void 0
        }), "script"
        ...
        var r, i, o;
        return t || (ve.createHTMLDocument ? ((r = (t = ae.implementation.createHTMLDocument("")).createElement("base")).href = ae.location.href, t.head.appendChild(r)) : t = ae), i = Ae.exec(e), o = !n && [], i ? [t.createElement(i[1])] : (i = C([e], t, o), o && o.length && we(o).remove(), we.merge([], i.childNodes))
    }, we.fn.load = function (e, t, n) {
        var r, i, o, a = this,
            s = e.indexOf(" ");
        return s > -1 && (r = Q(e.slice(s)), e = e.slice(0, s)), ye(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), a.length > 0 && we.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            var r, i, o, a, s, u, l = we.css(e, "position"),
                c = we(e),
                f = {};
            "static" === l && (e.style.position = "relative"), s = c.offset(), o = we.css(e, "top"), u = we.css(e, "left"), ("absolute" === l || "fixed" === l) && (o + u).indexOf("auto") > -1 ? (a = (r = c.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), ye(t) && (t = t.call(e, n, we.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, we.fn.extend({
        offset: function (e) {
        ...
        var n, r, i;
        if ("string" == typeof t && (n = e[t], t = e, e = n), ye(e)) return r = ue.call(arguments, 2), i = function () {
    ...
    }, we.isArray = Array.isArray, we.parseJSON = JSON.parse, we.nodeName = o, we.isFunction = ye, we.isWindow = xe, we.camelCase = h, we.type = r, we.now = Date.now, we.isNumeric = function (e) {
        var t = we.type(e);
...
}), define("carousel", ["jquery"], function (e) {
    function t(e) {
        this.isAnimate = !1, this.$ct = e, this.init(), this.bind(), this.autoPlay()
    }
    return t.prototype.init = function () {
        var e = this.$imgCt = this.$ct.find(".img-ct"),
            t = this.$imgs = this.$ct.find(".img-ct li");
        this.$preBtn = this.$ct.find(".pre"), this.$nextBtn = this.$ct.find(" .next"), this.$bullets = this.$ct.find(".bullet li");
        this.pageIndex = 0, this.imgWidth = t.width(), this.imgCount = t.length, e.append(t.first().clone()), e.prepend(t.last().clone()), e.width((this.imgCount + 2) * this.imgWidth), e.css({
            left: -this.imgWidth
        })
    }, t.prototype.bullesFun = function (e) {
        e > this.pageIndex ? this.playNext(e - this.pageIndex) : e < this.pageIndex && this.playPre(this.pageIndex - e)
    }, t.prototype.bind = function () {
        var e = this;
        this.$preBtn.click(function (t) {
            t.preventDefault(), e.playPre(1)
        }), this.$nextBtn.click(function (t) {
            t.preventDefault(), e.playNext(1)
        }), this.$bullets.click(function () {
            var t = $(this).index();
            e.bullesFun(t)
        })
    }, t.prototype.playNext = function (e) {
        var t = this;
        this.isAnimate || (this.isAnimate = !0, this.$imgCt.animate({
            left: "-=" + e * t.imgWidth
        }, 1500, "swing", function () {
            t.pageIndex += e, t.pageIndex === t.imgCount && (t.pageIndex = 0, t.$imgCt.css({
                left: -t.imgWidth
            })), t.setBullet(), t.isAnimate = !1
        }))
    }, t.prototype.playPre = function (e) {
        var t = this;
        this.isAnimate || (this.isAnimate = !0, this.$imgCt.animate({
            left: "+=" + e * this.imgWidth
        }, 1500, "swing", function () {
            t.pageIndex -= e, t.pageIndex < 0 && (t.pageIndex = t.imgCount - 1, t.$imgCt.css({
                left: -t.imgWidth * t.imgCount
            })), t.setBullet(), t.isAnimate = !1
        }))
...
}), define("loadWaterfull", ["jquery"], function (e) {
    function t() {
        this.unloadedImgs = 0, this.pageLength = 6, this.nodeWidth = e(".item-li").outerWidth(!0), this.boxWidth = e(".picture-box").width(), this.colNum = Math.floor(this.boxWidth / this.nodeWidth), this.hArr = [];
        for (var t = 0; t < this.colNum; t++) this.hArr[t] = 0;
        this.callbackFn(), this.loadMoreClick()
    }
    return t.prototype.callbackFn = function () {
        var t = this;
        this.unloadedImgs = 6, 0 !== this.unloadedImgs && (e(".picture-footer").find("div").addClass("hide"), e(".picture-footer").find(".loading").removeClass("hide")), this.getData(function (e) {
        ...
        var t = new XMLHttpRequest,
            n = this;
        this.url = "https://www.easy-mock.com/mock/5ad4e4effee5f81310617113/getTest?page=", t.open("get", this.url + this.pageLength, !0), t.send(), t.onreadystatechange = function () {
            if (4 === t.readyState)
        ...
        i.src = t, i.addEventListener("load", function () {
            n += "<li class='item-li'><a href='###'>", n += "<img class='item' src='" + t + "' ></a></li>";
            var i = e(n);
            e(".picture-box").append(i), r.waterfull(i), r.unloadedImgs -= 1, 0 === r.unloadedImgs && (e(".picture-footer").find("div").addClass("hide"), e(".picture-footer").find(".loadMore").removeClass("hide"))
        })
    }, t.prototype.waterfull = function (t) {
        for (var n = 0, r = this.hArr[0], i = 0; i < this.hArr.length; i++) this.hArr[i] < r && (n = i, r = this.hArr[i]);
        e(t).css({
            left: this.nodeWidth * n,
            top: r
        }), this.hArr[n] = t.outerHeight(!0) + r, e(".picture-box").height(Math.max.apply(null, this.hArr))
    }, t.prototype.loadMoreClick = function () {
        var t = this;
        e(".loadMore").click(function () {
            t.callbackFn()
        })
    }, t
}), define("scrollBarTo", [], function () {
    function e(e) {
        this.node = document.querySelector(e), this.node.addEventListener("click", function () {
            window.scrollTo(null, 0)
        })
    }
    return e
}), define("../index", ["jquery", "carousel", "loadWaterfull", "scrollBarTo"], function (e, t, n, r) {
    new t(e(".carousel")), new n, new r(".top")
}), require.config({
    baseUrl: "js/main",
    paths: {
        jquery: "../lib/jquery.min"
    }
}), require(["../index"]), define("main", function () {});